...
const { generate } = require('@wdio/allure-reporter').default
...
exports.config = {
	...
	reporters: ['spec', ['allure', { outputDir: join(process.cwd(), 'allure-results') }]],
	// eslint-disable-next-line func-names
	afterTest: function (test, context, { error, result, duration, passed, retries }) {
		if (!passed) {
			generate({
				framework: 'webdriverio',
				filename: join(process.cwd(), 'allure-results', `${test.title}.json`),
				...context
			})
		}
	}
	...
	// Add a hook to generate the Allure report after the test run is complete
